...
public class DebugSeven3
{
    public static void main(String[] args)
    {
        ...
        quote = kb.nextLine(); // FIXED

        System.out.print("Enter a character to search for >> ");
        charString = kb.next(); // FIXED

        searchChar = charString.charAt(0);

        System.out.println("index of('" + searchChar + "') is: " +
            quote.indexOf(searchChar)); // FIXED

        System.out.println("indexOf('a') is: " + quote.indexOf('a')); // FIXED
